...
/**
* Ajax Class for Omhelpdesk.
*
* @package	Omhelpdesk
* @subpackage	Class
*/
class OmhelpdeskCkClassAjax extends JObject
{
	/**
	...
	*/
	public static function responseHook($options = array(), $version)
	{
		...
		switch(strtoupper($options['renderExceptions']))
		{
			...
			case 'HTML':
				$return->transaction->htmlExceptions = OmhelpdeskClassView::renderMessages('HTML');
				break;

			case 'TEXT':
				$return->transaction->rawExceptions = OmhelpdeskClassView::renderMessages('TEXT');
				break;
			...
			default:
				...
				else
				{
					...
					$return->transaction->exceptions = OmhelpdeskClassView::renderMessages(null);
...
if (!class_exists('OmhelpdeskClassAjax')){ class OmhelpdeskClassAjax extends OmhelpdeskCkClassAjax{} }
