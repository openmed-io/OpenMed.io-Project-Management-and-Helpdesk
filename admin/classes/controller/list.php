...
* @subpackage	
*/
class OmhelpdeskCkClassControllerList extends JControllerAdmin
{
	/**
	...
	*/
	public function getModel($name = '', $prefix = 'OmhelpdeskModel', $config = array('ignore_request' => true))
	{
		if (empty($name))
		{
...
if (!class_exists('OmhelpdeskClassControllerList')){ class OmhelpdeskClassControllerList extends OmhelpdeskCkClassControllerList{} }
