...
* @subpackage	Form
*/
class OmhelpdeskCkClassFormField extends JFormField
{
	/**
...
if (!class_exists('OmhelpdeskClassFormField')){ class OmhelpdeskClassFormField extends OmhelpdeskCkClassFormField{} }
