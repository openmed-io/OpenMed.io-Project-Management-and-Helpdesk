...
/**
* JLoader Class for Omhelpdesk.
*
* @package	Omhelpdesk
* @subpackage	Class
*/
class OmhelpdeskCkClassLoader extends JLoader
{
	/**
	...
	*/
	public static function setup($enablePsr = true, $enablePrefixes = true, $enableClasses = true, $enableComponentLoader = false)
	{
		...
		if ($enableComponentLoader)
			spl_autoload_register(array('OmhelpdeskClassLoader', 'load'));
	}
...
if (!class_exists('OmhelpdeskClassLoader')){ class OmhelpdeskClassLoader extends OmhelpdeskCkClassLoader{} }
