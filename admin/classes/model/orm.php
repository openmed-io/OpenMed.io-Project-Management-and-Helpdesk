...
/**
* ORM Class for Omhelpdesk.
*
* @package	Omhelpdesk
* @subpackage	Class
*/
class OmhelpdeskCkClassModelOrm
{
	/**
	* Database.
	*
	...
	*/
	...
	{
		return new OmhelpdeskClassModelOrm($model);
	}
...
if (!class_exists('OmhelpdeskClassModelOrm')){ class OmhelpdeskClassModelOrm extends OmhelpdeskCkClassModelOrm{} }
