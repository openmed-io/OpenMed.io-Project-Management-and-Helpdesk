...
* @subpackage	Class
*/
class OmhelpdeskCkClassView extends CkJView
{
	/**
	...
	*/
	...
	{
		$this->addTemplatePath(JPATH_OMHELPDESK . '/fork/views/' . $this->getName() . '/tmpl');
	}
...
if (!class_exists('OmhelpdeskClassView')){ class OmhelpdeskClassView extends OmhelpdeskCkClassView{} }
