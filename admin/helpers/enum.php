...
class OmhelpdeskCkHelperEnum
{
	...
	* @param	string	$enumName	Name of the enumeration
	*
	* @return	object	Enumeration instance (OmhelpdeskHelperEnum)
	*/
	public static function getInstance($enumName)
	{
		...
		$enumeration = new OmhelpdeskHelperEnum($enumName);
...
if (!class_exists('OmhelpdeskHelperEnum')){ class OmhelpdeskHelperEnum extends OmhelpdeskCkHelperEnum{} }
