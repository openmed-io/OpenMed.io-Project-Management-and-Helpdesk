...
defined('OMHELPDESK_CPANEL_MAX_LENGTH') or define("OMHELPDESK_CPANEL_MAX_LENGTH", null);
defined('OMHELPDESK_CPANEL_ICON_SIZE') or define("OMHELPDESK_CPANEL_ICON_SIZE", 48);
defined('OMHELPDESK_CPANEL_BUTTON_WIDTH') or define("OMHELPDESK_CPANEL_BUTTON_WIDTH", 100);
defined('OMHELPDESK_CPANEL_BUTTON_HEIGHT') or define("OMHELPDESK_CPANEL_BUTTON_HEIGHT", 100);
...
class OmhelpdeskCkHelperMenu
{
	...
	*/
	protected static function getXml()
	{
		...
		{
			if ($client == 'admin')
				$xmlFileBase = JPATH_ADMIN_OMHELPDESK;
			else
				$xmlFileBase = JPATH_SITE_OMHELPDESK;
	...
	*/
	...
	{
		$maxLength = OMHELPDESK_CPANEL_MAX_LENGTH;
		$iconSize = OMHELPDESK_CPANEL_ICON_SIZE;
		$buttonWidth = OMHELPDESK_CPANEL_BUTTON_WIDTH;
		$buttonHeight = OMHELPDESK_CPANEL_BUTTON_HEIGHT;
...
if (!class_exists('OmhelpdeskHelperMenu')){ class OmhelpdeskHelperMenu extends OmhelpdeskCkHelperMenu{} }
