...
* @subpackage	Form
*/
class OmhelpdeskCkFormFieldCkcbrow extends OmhelpdeskClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkcbrow')){ class JFormFieldCkcbrow extends OmhelpdeskCkFormFieldCkcbrow{} }
