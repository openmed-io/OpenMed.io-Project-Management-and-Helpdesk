...
* @subpackage	Form
*/
class OmhelpdeskCkFormFieldCkcombo extends OmhelpdeskClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkcombo')){ class JFormFieldCkcombo extends OmhelpdeskCkFormFieldCkcombo{} }
