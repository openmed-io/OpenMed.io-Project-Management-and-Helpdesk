...
* @subpackage	Form
*/
class OmhelpdeskCkFormFieldCkeditor extends OmhelpdeskClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkeditor')){ class JFormFieldCkeditor extends OmhelpdeskCkFormFieldCkeditor{} }
