...
* @subpackage	Form
*/
class OmhelpdeskCkFormFieldCklimit extends OmhelpdeskClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCklimit')){ class JFormFieldCklimit extends OmhelpdeskCkFormFieldCklimit{} }
