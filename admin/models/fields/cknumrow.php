...
* @subpackage	Form
*/
class OmhelpdeskCkFormFieldCknumrow extends OmhelpdeskClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCknumrow')){ class JFormFieldCknumrow extends OmhelpdeskCkFormFieldCknumrow{} }
