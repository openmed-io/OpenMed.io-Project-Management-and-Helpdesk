...
* @subpackage	Form
*/
class OmhelpdeskCkFormFieldCksearch extends OmhelpdeskClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCksearch')){ class JFormFieldCksearch extends OmhelpdeskCkFormFieldCksearch{} }
