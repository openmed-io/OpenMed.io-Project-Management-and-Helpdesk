...
* @subpackage	Form
*/
class OmhelpdeskCkFormFieldCksort extends OmhelpdeskClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCksort')){ class JFormFieldCksort extends OmhelpdeskCkFormFieldCksort{} }
