...
* @subpackage	Form
*/
class OmhelpdeskCkFormFieldCktext extends OmhelpdeskClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCktext')){ class JFormFieldCktext extends OmhelpdeskCkFormFieldCktext{} }
