...
* @subpackage	Form
*/
class OmhelpdeskCkFormFieldEnum extends JFormFieldGroupedList
{
	/**
	* Items cache.
	*
	...
	*/
	protected function getItems()
	{
		if (!self::$_items)
		{
			...
			self::$_items = OmhelpdeskHelperEnum::_($enumName);
		}
...
if (!class_exists('JFormFieldEnum')){ class JFormFieldEnum extends OmhelpdeskCkFormFieldEnum{} }
