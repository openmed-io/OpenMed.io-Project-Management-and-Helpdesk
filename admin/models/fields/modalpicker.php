...
* @subpackage	Form
*/
class OmhelpdeskCkFormFieldModalpicker extends JFormField
{
	/**
	* Extension name.
	*
	...
	*/
	protected function getSelectedLabel()
	{
		...
		$selectedItem = OmhelpdeskHelper::getData($model->getNameItem(), array(
...
if (!class_exists('JFormFieldModalpicker')){ class JFormFieldModalpicker extends OmhelpdeskCkFormFieldModalpicker{} }
