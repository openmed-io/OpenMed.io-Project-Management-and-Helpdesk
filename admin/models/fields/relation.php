...
* @subpackage	Form
*/
class OmhelpdeskCkFormFieldRelation extends JFormFieldModel
{
	/**
	* The form field type.
	*
	...
	*/
	protected function getRelation()
	{
		...
		$model = CkJModel::getInstance($modelName, 'OmhelpdeskModel');
...
if (!class_exists('JFormFieldRelation')){ class JFormFieldRelation extends OmhelpdeskCkFormFieldRelation{} }
