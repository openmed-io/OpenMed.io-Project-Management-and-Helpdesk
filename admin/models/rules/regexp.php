...
* @subpackage	Form
*/
class OmhelpdeskCkFormRuleRegexp extends OmhelpdeskClassFormRule
{
	/**
...
if (!class_exists('JFormRuleRegexp')){ class JFormRuleRegexp extends OmhelpdeskCkFormRuleRegexp{} }
