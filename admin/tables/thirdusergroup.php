...
*/
class OmhelpdeskCkTableThirdusergroup extends OmhelpdeskClassTable
{
	/**
	* Constructor
	*
...
if (!class_exists('OmhelpdeskTableThirdusergroup')){ class OmhelpdeskTableThirdusergroup extends OmhelpdeskCkTableThirdusergroup{} }
