...
/**
* Script file of Omhelpdesk component
*
* @package	Omhelpdesk
* @subpackage	Installer
*/
class com_omhelpdeskInstallerScript
{
	/**
	...
	*/
	...
	{
		$adapter->getParent()->setRedirectURL('index.php?option=com_omhelpdesk');
	...
	*/
	public function postflight($type, JAdapterInstance $adapter)
	{
		...
		$txtComponent = JText::_('COM_OMHELPDESK');
