...
*/
function OmhelpdeskCkBuildRoute(&$query)
{
	$view = null;
	$segments = array();
	if(isset($query['view']))
...
*/
function OmhelpdeskCkParseRoute($segments)
{
	$vars = array();
	$view = null;
...
*/
function OmhelpdeskCkParseSlug($slug, $model, $aliasKey)
{
	$parts = explode( ':', $slug );
	$id = $parts[0];
...
*/
function OmhelpdeskCkBuildSlug($id, $model, $aliasKey)
{
	$item = OmhelpdeskHelper::getData($model, array(
...
*/
function OmhelpdeskCkRouteConfig()
{
	return array(
		'tickets' => array(
			array(
