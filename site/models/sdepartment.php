...
* @subpackage	Classes
*/
class OmhelpdeskCkModelSdepartment extends OmhelpdeskClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'deppartment', 'STRING');
	}
	...
	*/
	public function getTable($type = 'sdepartment', $prefix = 'OmhelpdeskTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_omhelpdesk.edit.sdepartment.data', array());
		...
		if (empty($data)) {
			...
			if ($this->getState('sdepartment.id') == 0)
			{
				$jinput = JFactory::getApplication()->input;
	...
	* @param	integer	$pk	The primary id key of the sdepartment
	*
	* @return	void
	*/
	...
	{
		//FROM : Main table
		$query->from('#__omhelpdesk_sdepartments AS a');
...
if (!class_exists('OmhelpdeskModelSdepartment')){ class OmhelpdeskModelSdepartment extends OmhelpdeskCkModelSdepartment{} }
