...
* @subpackage	Classes
*/
class OmhelpdeskCkModelSdepartments extends OmhelpdeskClassModelList
{
	/**
	* Default item layout.
	*
	* @var array
	*/
	public $itemDefaultLayout = 'deppartment';
	...
	*/
	...
	{
		$item->section = JText::_('OMHELPDESK') . ' - ' . JText::_('OMHELPDESK_VIEW_SOURCE_DEPARTMENT');
	...
	*/
	protected function prepareQuery(&$query)
	{
		...
		// ORDERING
		$orderCol = $this->getState('list.ordering', 'published');
...
if (!class_exists('OmhelpdeskModelSdepartments')){ class OmhelpdeskModelSdepartments extends OmhelpdeskCkModelSdepartments{} }
