...
* @subpackage	Classes
*/
class OmhelpdeskCkModelSprint extends OmhelpdeskClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'sprint', 'STRING');
	}
	...
	*/
	public function getTable($type = 'sprint', $prefix = 'OmhelpdeskTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_omhelpdesk.edit.sprint.data', array());
	...
	* @param	integer	$pk	The primary id key of the sprint
	*
	* @return	void
	*/
...
if (!class_exists('OmhelpdeskModelSprint')){ class OmhelpdeskModelSprint extends OmhelpdeskCkModelSprint{} }
