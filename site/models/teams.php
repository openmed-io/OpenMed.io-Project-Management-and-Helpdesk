...
* @subpackage	Classes
*/
class OmhelpdeskCkModelTeams extends OmhelpdeskClassModelList
{
	/**
	* Default item layout.
	*
	...
	*/
	...
	{
		$item->section = JText::_('OMHELPDESK') . ' - ' . JText::_('OMHELPDESK_VIEW_TEAM');
	...
	*/
	protected function prepareQuery(&$query)
	{
		...
		// ORDERING
		$orderCol = $this->getState('list.ordering', 'team');
...
if (!class_exists('OmhelpdeskModelTeams')){ class OmhelpdeskModelTeams extends OmhelpdeskCkModelTeams{} }
