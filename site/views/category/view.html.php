...
* @subpackage	Category
*/
class OmhelpdeskCkViewCategory extends OmhelpdeskClassView
{
	/**
	...
	*/
	protected function displayCategory($tpl = null)
	{
		...
		if (($isNew && $model->canCreate()) || (!$isNew && $item->params->get('access-edit')))
			JToolBarHelper::save('category.save', "OMHELPDESK_JTOOLBAR_SAVE_CLOSE");
		// Save
		if (($isNew && $model->canCreate()) || (!$isNew && $item->params->get('access-edit')))
			JToolBarHelper::apply('category.apply', "OMHELPDESK_JTOOLBAR_SAVE");
		// Cancel
...
if (!class_exists('OmhelpdeskViewCategory')){ class OmhelpdeskViewCategory extends OmhelpdeskCkViewCategory{} }
