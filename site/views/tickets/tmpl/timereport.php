...
<form action="<?php echo(JRoute::_("index.php")); ?>" method="post" name="adminForm" id="adminForm">
	<div class="row-fluid">
		<div id="contents" class="span12">
			...
			<!-- BRICK : filters -->
			<div class="pull-left">
					<?php echo $this->filters['filter_finish_date_n_time_from']->input;?>
					<?php echo $this->filters['filter_finish_date_n_time_to']->input;?>
			</div>
			...
			<div class="pull-left">
				<?php echo $this->filters['filter_pilot']->input;?>
			</div>


			<div class="pull-left">
				<?php echo $this->filters['filter_overtime']->input;?>
			</div>
	...
	<?php 
		...
		'values' => array(
					'view' => $jinput->get('view', 'tickets'),
					'layout' => $jinput->get('layout', 'timereport'),
					'boxchecked' => '0',
